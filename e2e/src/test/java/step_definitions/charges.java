...
public class charges extends testBase {
    ...
    public void iVerifyThatTheChargesMustasheTabIsGreen() throws Throwable {
        driver.findElement(By.cssSelector("tab-buttons > div > div:nth-child(2) > span.au-target.state-border.state-valid")).isDisplayed();
    }
...
//        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div > button.btn.btn.btn-tertiary.arrow-blue-right.au-target")));
    ...
    public void gasketCoverPlateICheckedVanStock(int arg0) throws Throwable {
        WebElement ele = driver.findElement(By.cssSelector("div:nth-child(5) > div:nth-child(1) > div > div > div:nth-child(3) > checkbox > button"));
        JavascriptExecutor executor = (JavascriptExecutor)driver;
        executor.executeScript("arguments[0].click();", ele);
        Thread.sleep(5000);
    }
    ...
    public void activitiesISelectTask(String value) throws Throwable {
        WebElement ele = driver.findElement(By.cssSelector("div > div.au-target.col-xs-3.details-list-item-col.state-not-visited > h4 > span:nth-child(1) > task-description > task-action > catalog-lookup"));
        JavascriptExecutor executor = (JavascriptExecutor)driver;
        executor.executeScript("arguments[0].click();", ele);
        Thread.sleep(5000);
    }
    ...
    public void i_click_the_got_it_risks_button() throws Throwable {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(ChargesPage.charge_ok_button_xpath)));
    ...
    public void partsBasketIClickQuickAdd() throws Throwable {
        WebElement ele = driver.findElement(By.cssSelector("div > material-search-summary > div > div:nth-child(1) > div.col-xs-3 > button"));
        JavascriptExecutor executor = (JavascriptExecutor)driver;
        executor.executeScript("arguments[0].click();", ele);
        Thread.sleep(3000);
