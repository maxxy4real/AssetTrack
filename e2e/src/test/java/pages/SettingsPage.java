...
public class SettingsPage {
    ...
    @FindBy(how = How.CSS, using = "body > div > div.main-container.full-screen > router-view > compose:nth-child(2) > div:nth-child(4) > compose > div > div > div.card-header.card-title.au-target > i")
    @CacheLookup
