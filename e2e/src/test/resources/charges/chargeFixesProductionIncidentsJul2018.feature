@chargeFixesProductionIncidents
Feature: Charge Incident Fixes 2018
  ...
  Scenario: Complete Job 1389425001, scenario 2
    ...
    And I click the settings Tab
    And I click the support operations chevron down
    Then I verify that last job update is "{  job: {    status: {      code: 04,      timestamp: 2018-08-23T09:29:53Z    },    sourceSystem: W,    engineerId: 9999991,    dispatchTime: 2018-08-23T09:29:53Z,    enrouteTime: 2018-08-23T09:29:53Z,    onsiteTime: 2018-08-23T09:29:53Z,    completionTime: 2018-08-23T09:29:53Z,    paymentNonCollectionReasonCode: XE,    visitId: WMW00057420,    premises: {      id: L271314,      address: {},      contact: {        id: 022201831,        contactUpdatedMarker: A      },      safety: {        gasELIReading: <1,        safetyNoticeNotLeftReason: ,        gasInstallationTightnessTestDone: false,        gasMeterInstallationSafe: Yes,        jobPartLJReportable: true,        riskIdentifiedAtProperty: false      },      unsafeDetail: {        reasons: []      }    },    tasks: [      {        id: 1389425001001,        newWork: false,        jobType: HU,        applianceType: AGA,        chargeType: ALP3FI1,        sequence: 2,        applianceId: 202224174,        status: C,        componentEndTime: 2018-08-23T09:29:53Z,        componentStartTime: 2018-08-23T09:29:53Z,        report: 54CODE aaaaaaaaaa,        energyEfficiencyOutcome: NOR,        workDuration: 1,        workedOnCode: AP,        visitActivityCode: CPC,        partsCharged: [          {            charge: 321,            quantityCharged: 1,            quantityUsed: 2,            description: 22mm Speedfit Tank Connector TOTE,            stockReferenceId: F00006          }        ],        partsClaimedUnderWarranty: [          {            claimedUnderWarrantyReasonDescription: aaaaaaaaaaaaaaa,            partReturnedIndicator: true,            quantityClaimed: 1,            stockReferenceId: F00006          }        ],        jobStatusCategory: C,        chargeableTime: 1,        chargeExcludingVAT: 4662,        vatAmount: 9324,        vatCode: D,        subsequentJobIndicator: false,        discountAmount: 0,        standardLabourChargeIndicator: false,        totalLabourCharged: 4341      },      {        id: 1389425001002,        newWork: false,        jobType: GU,        applianceType: CHB,        chargeType: ALF2FIS,        sequence: 2,        applianceId: 202224173,        status: C,        componentEndTime: 2018-08-23T09:29:53Z,        componentStartTime: 2018-08-23T09:29:53Z,        report: 54CODE aaaaaaaaaa,        energyEfficiencyOutcome: NOR,        workDuration: 1,        workedOnCode: AP,        visitActivityCode: CPC,        partsCharged: [          {            charge: 321,            quantityCharged: 1,            quantityUsed: 2,            description: 22mm Speedfit Tank Connector TOTE,            stockReferenceId: F00006          },          {            charge: 769,            quantityCharged: 2,            quantityUsed: 2,            description: V -Carbon Brush Pair (L) TOTE,            stockReferenceId: E07067          }        ],        partsClaimedUnderWarranty: [          {            claimedUnderWarrantyReasonDescription: This is a test,            partReturnedIndicator: true,            quantityClaimed: 1,            stockReferenceId: F00006          }        ],        jobStatusCategory: C,        chargeableTime: 1,        chargeExcludingVAT: 6200,        vatAmount: 3100,        vatCode: F,        subsequentJobIndicator: true,        discountAmount: 0,        standardLabourChargeIndicator: false,        totalLabourCharged: 4341      }    ]  },  appliances: [    {      updateMarker: A,      applianceType: AGA,      id: 202224174,      readings: [],      safety: {        gasMeterInstallationSafe: Yes,        applianceSafe: Y,        installationSafe: Y,        detailsDate: 2018-08-23T09:29:53Z,        workedOnAppliance: false,        visuallyCheckRelight: Y,        applianceToCurrentStandards: X      }    },    {      updateMarker: A,      applianceType: CHB,      id: 202224173,      readings: [],      safety: {        gasMeterInstallationSafe: Yes,        applianceSafe: Y,        installationSafe: Y,        detailsDate: 2018-08-23T09:29:53Z,        workedOnAppliance: false,        visuallyCheckRelight: Y,        applianceToCurrentStandards: X      }    }  ]}"
    And I click Customer Details Tab
  ...
  Scenario: Complete Job 1301525001 scenario 6
    ...
    And Tabs - I click "Parts" button
    And 555123 - Gasket - Cover Plate - I checked Van Stock
    And Parts Basket - Associated Activity - I select "C/HEAT BLR"
    And I select "No" for Is this part going to be returned as a Warranty claim
    And Parts Basket - I click Quick Add
    And I click on the Charges tab
    And I click I Understand. Click to continue
    ...
    And I click the settings Tab
    And I click the support operations chevron down
    Then I verify that last job update is "{  job: {    status: {      code: 04,      timestamp: 2018-08-23T09:29:53Z    },    sourceSystem: W,    engineerId: 9999991,    dispatchTime: 2018-08-23T09:29:53Z,    enrouteTime: 2018-08-23T09:29:53Z,    onsiteTime: 2018-08-23T09:29:53Z,    completionTime: 2018-08-23T09:29:53Z,    paymentNonCollectionReasonCode: XE,    visitId: WMW00057432,    premises: {      id: L271306,      address: {},      contact: {        id: 022201823,        contactUpdatedMarker: A      },      risks: [],      safety: {        gasELIReading: <1,        safetyNoticeNotLeftReason: ,        gasInstallationTightnessTestDone: false,        gasMeterInstallationSafe: Yes,        jobPartLJReportable: true,        riskIdentifiedAtProperty: false      },      unsafeDetail: {        reasons: []      }    },    tasks: [      {        id: 1301525001001,        newWork: false,        jobType: CB,        applianceType: CHB,        chargeType: NCH2SIS,        sequence: 1,        applianceId: 202224153,        status: C,        componentEndTime: 2018-08-23T09:29:53Z,        componentStartTime: 2018-08-23T09:29:53Z,        report: 54CODE aaaaaaaaaa,        energyEfficiencyOutcome: NOR,        workDuration: 1,        workedOnCode: AP,        visitActivityCode: CPC,        partsUsed: [          {            quantityUsed: 1,            quantityCharged: 0,            requisitionNumber: ,            buyingUnitPrice: 2838,            description: Timer Mechanical EMT 2 TOTE,            sourceCategory: P,            charge: 2838,            stockReferenceId: 555123          }        ],        jobStatusCategory: C,        chargeableTime: 1,        chargeExcludingVAT: 0,        vatAmount: 0,        vatCode: D,        subsequentJobIndicator: true      },      {        id: 1301525001002,        newWork: false,        jobType: HU,        applianceType: CHB,        chargeType: ALP2SIS,        sequence: 1,        applianceId: 202224153,        status: C,        componentEndTime: 2018-08-23T09:29:53Z,        componentStartTime: 2018-08-23T09:29:53Z,        report: 54CODE aaaaaaaaaa,        energyEfficiencyOutcome: NOR,        fixedPriceQuotationAmount: 014000,        workDuration: 1,        workedOnCode: AP,        visitActivityCode: CPC,        jobStatusCategory: C,        chargeableTime: 1,        chargeExcludingVAT: 14000,        vatAmount: 28000,        vatCode: D,        subsequentJobIndicator: false,        discountAmount: 0,        standardLabourChargeIndicator: false,        totalLabourCharged: 0      }    ]  },  appliances: [    {      updateMarker: A,      applianceType: CHB,      id: 202224153,      systemType: 0,      readings: [],      safety: {        gasMeterInstallationSafe: Yes,        applianceSafe: Y,        installationSafe: Y,        detailsDate: 2018-08-23T09:29:53Z,        workedOnAppliance: false,        visuallyCheckRelight: Y,        applianceToCurrentStandards: X      }    }  ]}"
    And I click Customer Details Tab
  ...
  Scenario: Complete Job 1359425001 scenario 7
    ...
    And I click the settings Tab
    And I click the support operations chevron down
    Then I verify that last job update is "{  job: {    status: {      code: 04,      timestamp: 2018-08-23T09:29:53Z    },    sourceSystem: W,    engineerId: 9999991,    dispatchTime: 2018-08-23T09:29:53Z,    enrouteTime: 2018-08-23T09:29:53Z,    onsiteTime: 2018-08-23T09:29:53Z,    completionTime: 2018-08-23T09:29:53Z,    paymentNonCollectionReasonCode: XE,    visitId: WMW00057426,    premises: {      id: L271320,      address: {},      contact: {        id: 022201839,        contactUpdatedMarker: A      },      safety: {        gasELIReading: <1,        safetyNoticeNotLeftReason: ,        gasInstallationTightnessTestDone: false,        gasMeterInstallationSafe: Yes,        riskIdentifiedAtProperty: false      },      unsafeDetail: {        reasons: []      }    },    tasks: [      {        id: 1359425001001,        newWork: false,        jobType: PL,        applianceType: WAW,        chargeType: ALPNONE,        sequence: 2,        applianceId: 202224193,        status: C,        componentEndTime: 2018-08-23T09:29:53Z,        componentStartTime: 2018-08-23T09:29:53Z,        report: 54CODE aaaaaaaaaa,        energyEfficiencyOutcome: NOR,        workDuration: 1,        workedOnCode: AP,        visitActivityCode: CPC,        partsCharged: [          {            charge: 2838,            quantityCharged: 1,            quantityUsed: 1,            description: Timer Mechanical EMT 2 TOTE,            stockReferenceId: 555123          },          {            charge: 2672,            quantityCharged: 2,            quantityUsed: 2,            description: Wax Sensor,            stockReferenceId: 108014          }        ],        partsUsed: [          {            quantityUsed: 1,            quantityCharged: 1,            requisitionNumber: ,            buyingUnitPrice: 2838,            description: Timer Mechanical EMT 2 TOTE,            sourceCategory: P,            charge: 2838,            stockReferenceId: 555123          }        ],        partsNotUsed: [          {            fieldComponentVisitSeq: 2,            locationCode: ,            reasonCode: WG,            quantityNotUsed: 1,            requisitionNumber: ,            stockReferenceId: 108014          }        ],        jobStatusCategory: C,        chargeableTime: 1,        chargeExcludingVAT: 14905,        vatAmount: 29810,        vatCode: D,        subsequentJobIndicator: false,        discountAmount: 0,        standardLabourChargeIndicator: false,        totalLabourCharged: 6723      }    ]  },  appliances: [    {      updateMarker: A,      applianceType: WAW,      id: 202224193,      readings: [],      safety: {        gasMeterInstallationSafe: Yes,        applianceSafe: Y,        installationSafe: Y,        detailsDate: 2018-08-23T09:29:53Z,        workedOnAppliance: false,        visuallyCheckRelight: Y,        applianceToCurrentStandards: X      }    }  ]}"
    And I click Customer Details Tab
